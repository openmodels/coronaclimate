...
expprior.var <- c('beta', 'omega', 'omega')
expprior.period <- c('two', 'one', 'two')
expprior.sign <- c(1, 1, -1)
expprior.intercept <- c(-3.675333, -2.296955, -2.325246)
expprior.slope <- c(-0.02568723, -0.03408594, -0.20923385)
