...
result.files <- c('epimodel-0604.csv', 'epimodel-0604-ww.csv', 'epimodel-0614.csv', 'epimodel-0615.csv', 'epimodel-0616.csv', 'epimodel-meta-0616.csv', 'epimodel-0728.csv', 'epimodel-0730.csv', 'epimodel-0803.csv', 'epimodel-0805.csv', 'epimodel-0806.csv', 'epimodel-0806-x5.csv', 'epimodel-meta-0806-x5.csv', 'epimodel-0817.csv', 'epimodel-meta-0817.csv')
result.names <- c('Kucharski et al.', 'Include Weather', 'Handle Deaths', 'Improve Priors', 'Death & Not', 'Full Meta', 'Early & Late', 'Drop Reportable', 'Mobility Prior', 'Constant Omega', 'Weather Priors', 'Loose Priors', 'Full Meta 2', 'New Weather', 'Full Meta 3')
result.ctime <- parse_date_time(c('06/04/2020 20:05:51', '06/11/2020 07:49:16', '06/14/2020 14:03:17', '06/15/2020 17:26:33', '06/17/2020 17:59:03', '06/18/2020 15:17:53', '07/30/2020 13:09:45', '08/01/2020 10:52:20', '08/03/2020 18:33:48', '08/06/2020 00:05:45', '08/06/2020 11:21:01', '08/06/2020 23:03:18', '08/13/2020 13:16:36', NA, NA), '%m/%d/%y %H:%M:%S', tz='GB')
